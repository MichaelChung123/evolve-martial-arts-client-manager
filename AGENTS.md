...
- Do not write or add tests unless the user explicitly asks for tests. If tests would help, note the gap and ask for confirmation instead.
...
- Apply SOLID principles when they fit the JS/Vue/Vuetify context; avoid over-engineering.
...
- Keep domain logic framework-agnostic; isolate Vue/Vuetify specifics at the edges.
